...
// require( ["/db/connect.js" ], function(connect){} ) ;
...
Code.init = function() {
  ...
  Code.bindClick( 'trashButton', stepCode )
...
// initial interpreter highlightbox
...
function stepCode() {
  ...
  Code.code = Blockly.JavaScript.workspaceToCode(Code.workspace);
 ...
 */
function pushcode() {
  var code111 = Blockly.JavaScript.workspaceToCode(Code.workspace);
  alert( code111 ) ;

  var message = { "script" : code111 } ;
    $.ajax({                                       
      url:'/',                                                              
...
// var node = document.getElementById( "jscode" ) ;
